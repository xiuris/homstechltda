...
# <=== Inicio Configurações Personalizadas ===>
    ...
    # <=== Inicio Configuração de dados de E-mail ===>
        ...
        if [ "$resposta" = "N" ] || [ "$resposta" = "n" ]; then
            ...
            # ⚡ Bolt: Consolidated 6 sequential sed calls into a single invocation using multiple -e expressions.
            # This reduces process spawns and file I/O operations by ~83% for this block, improving script execution speed.
