...
class Os_model extends CI_Model
{
    ...
    public function getOs($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        ...
        // Removed unnecessary joins with produtos_os and servicos_os to improve performance.
        // These joins were causing Cartesian products and were not needed as totals are calculated via subqueries in the controller.
